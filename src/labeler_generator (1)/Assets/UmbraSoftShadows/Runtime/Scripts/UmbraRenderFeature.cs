...
namespace Umbra {
    ...
    internal partial class UmbraRenderFeature : ScreenSpaceShadows {
        ...
        //public static Light unityLight;
        ...
        public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData) {
            ...
            if (shouldEnqueue) {
                ...
                if (!settings.debugShadows && settings.profile != null &&
                    settings.profile.contactShadows && (settings.profile.shadowSource == ShadowSource.UnityShadows || settings.profile.contactShadowsInjectionPoint == ContactShadowsInjectionPoint.AfterOpaque)) {
                ...
                using (new ProfilingScope(cmd, m_ProfilingSampler)) {
                    ...
                    if (useFrame) {
                        ...
                        if (profile.shadowSource == ShadowSource.UnityShadows) {
                            ...
                            cmd.SetGlobalVector(ShaderParams.ShadowData2, new Vector4(1f - profile.contactStrength, profile.distantSpread, shadowMaxDistance / farClipPlane, profile.lightSize * 0.02f));
